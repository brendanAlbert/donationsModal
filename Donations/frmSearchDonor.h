...
namespace Donations {
	...
	public ref class frmSearchDonor : public System::Windows::Forms::Form
	{
	public:
		frmSearchDonor(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnClear->Click += gcnew System::EventHandler(this, &frmSearchDonor::btnClear_Click);
			// 
			// btnSearch
			// 
			...
			this->btnSearch->Click += gcnew System::EventHandler(this, &frmSearchDonor::btnSearch_Click);
			// 
			// btnExit
			// 
			...
			this->btnExit->Click += gcnew System::EventHandler(this, &frmSearchDonor::btnExit_Click);
			// 
			// frmSearchDonor
			// 
			...
			this->Name = L"frmSearchDonor";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Search Donor";
			this->Load += gcnew System::EventHandler(this, &frmSearchDonor::frmSearchDonor_Load);
...
#pragma endregion
		...
		// Load
		private: System::Void Donations::frmSearchDonor::frmSearchDonor_Load(System::Object^  sender, System::EventArgs^  e)
		{
			this->txtMemberID->Text = "";
		}

		// Exit btn
		System::Void Donations::frmSearchDonor::btnExit_Click(System::Object^  sender, System::EventArgs^  e)
		{
			this->Close();
		}

		// Search btn
		private: System::Void Donations::frmSearchDonor::btnSearch_Click(System::Object^  sender, System::EventArgs^  e)
		{
		...
		// Clear btn
		private: System::Void Donations::frmSearchDonor::btnClear_Click(System::Object^  sender, System::EventArgs^  e)
		{
			txtMemberID->Clear();
			labelName->Text = "";
			labelDonation->Text = "";
